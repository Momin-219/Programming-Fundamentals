...
void subtraction(int matrix1[][columns], int matrix2[][columns])
{
	...
	cout<<"The final matrix after subtraction is: "<<endl;
	for(int i=0; i<rows; i++)
	{
		for(int j=0; j<columns; j++)
		{
...
int main()
{
	...
	cout<<"We will subtract matrix2 from matrix1 in this program"<<endl;
	enter1(matrix1);
	enter2(matrix2);
